...
import frc.DELib.Subsystems.ISubsystem;
...
public class SparkSysid {
    ...
    public SparkSysid(SysidConfiguration configuration, SubsystemBase subsystem, Consumer<Measure<Voltage>> runCharacterization){
