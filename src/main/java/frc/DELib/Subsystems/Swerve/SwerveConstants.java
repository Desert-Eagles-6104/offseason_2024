...
public class SwerveConstants {
    ...
    * Divide SYSID values by 12 to convert from volts to percent output for CTRE */
    ...
    public TalonFXConfiguration driveTalonFXConfigs(){
        ...
        configs.CurrentLimits.SupplyTimeThreshold = drivePeakCurrentDuration;
    ...
    public TalonFXConfiguration steerTalonFXConfigs(){
        ...
        configs.CurrentLimits.SupplyCurrentThreshold = anglePeakCurrentLimit;
        configs.CurrentLimits.SupplyTimeThreshold = anglePeakCurrentDuration;
